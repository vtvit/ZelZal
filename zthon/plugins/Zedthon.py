    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if str_y[0].lower() == "ytdl" and len(str_y) == 2:
            ...
            if found_:
                ...
                result = types.InputBotInlineResult(
                    ...
                    description="⬇️ ئێرە دابگرە بۆ داگرتن",
            ...
            buttons = [
                ...
                Button.inline(text="پیشاندانی بەربژارەکان", data="show_pmpermit_options"),
        ...
        buttons = [
            ...
            (
                ...
                Button.url("چـەناڵـی سـەرچـاوە", "https://t.me/IQUSER0"),

                Button.url(

                    "گـەشـەپـێـدەری سـەرچـاوە",
